...
SECRET_KEY = 'django-insecure-t_#_5nc$)tazf%-bs-%di-2yr+z*(%a+e^efxgo)%4riuj=u**'
...
EMAIL_HOST_PASSWORD = '694kdXPQmnj6D701jakn'
...
ACCOUNT_FORMS = {'signup': 'mmorpg.models.BasicSignupForm'}
